...
struct Glass {
    ...
    func getDescription() -> String {
        ...
        case GlassType.Snifter:
            return "A beer connoisseur favorite. These wide-bowled and stemmed glasses with their tapered mouths allow for capturing the aromas of brews. They provide room to swirl and agitate. Popular for barleywines, dark ales, and those strong double imperial beers."
        case GlassType.Pint:
