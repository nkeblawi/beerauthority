...
struct BrewingProcess {
    ...
    private let ingredients = "Beer is made from four basic ingredients: " + "\r\n" +
        ...
        "4) Yeast " + "\r\n" +
            "\r\n" +
        "The basic idea is to extract the sugars from grains (barley) so that the yeast can turn it into alcohol and carbon dioxide, creating beer." + "\r\n"
    ...
    private let fermentation = "Once the hour long boil is over, the wort is cooled, strained and filtered. Wort is then put in a fermenting vessel and yeast is added to it. At this point the brewing is complete and the fermentation begins. The beer is stored a few weeks at room temperature (in the case of ales) or longer at cold temperatures (in the case of lagers) while the yeast works its fermentation magic. Basically, the yeast eats up all that sugar in the wort and spits out CO2 and alcohol as waste products." + "\r\n"
